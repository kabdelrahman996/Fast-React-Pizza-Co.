...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary:
      "text-sm inline-block md:py-3.5 cursor-pointer px-4 py-3 md:px-6 md:py-2.5 rounded-full border-2 border-stone-300 font-semibold tracking-wide text-stone-800 uppercase transition-colors duration-300 hover:bg-stone-300 hover:text-stone-800 focus:bg-stone-300 focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:outline-none disabled:cursor-not-allowed ",
  };
